export const translations = {
  tr: {
    ...
    hero: {
      subtitle: "Profesyonel kısa dönem kiralama danışmanlığı",
      title: {
        prefix: "Gayrimenkulünüzü",
        suffix: "dönüştüren kiralama hizmeti",
      },
      rotatingWords: [
        "değere",
        "gelire",
      ...
      services: {
        listing: "İlan oluşturma",
        photography: "Fotoğraf",
        pricing: "Fiyatlandırma",
        pricingMobile: "Fiyat Hesaplama",
        support: "7/24 iletişim",
        cleaning: "Temizlik",
        reporting: "Aylık raporlama",
    ...
    about: {
      ...
      description2:
        "Müşteri memnuniyetini ön planda tutarak, her projede en yüksek kalite standartlarını hedefliyoruz. Modern teknolojiler ve best practice'lerle çalışıyor, sürekli gelişim ve öğrenme kültürünü benimsiyoruz.",
      description3:
        "Ekibimiz, alanında uzman profesyonellerden oluşmakta ve her projede mükemmellik için çalışmaktadır.",
      stats: {
      ...
      team: {
        ...
        members: [
          ...
          {
            name: "Sinem Nefes Tekin",
            role: "Brand & Marketing Director",
            image: "why2",
          },
          {
            name: "Sedef Akbalık",
            role: "Operations & Istanbul Representative",
            image: "why3",
          },
          {
            name: "Seda Akbalık",
            role: "International Operations – London",
            image: "why4",
          },
          {
            name: "Yiğit Oben Yılmaz",
            role: "Regional Representative – Bodrum",
            image: "why5",
          },
        ],
      },
      ...
      airbnbManagement: {
        title: "Gayrimenkulünüzün potansiyeli var.",
        subtitle: "Gayrimenkulünüz hakkında fiyat bilgisi alın, sizinle iletişime geçelim.",
        button: "Başlayın",
        label: "Airbnb Yönetimi",
        guestExperience: {
          title: "Misafirleriniz için keyifli bir deneyim",
          items: [
            {
              title: "Giriş ve anahtar teslimi",
              description: "Misafirlerinizin varışını zahmetsiz hale getirin. Her misafir için sorunsuz ve kusursuz bir check-in düzenleyecek ve konaklamaları boyunca onlara yardımcı olmaya hazır olacağız. Mutlu misafirler, her zaman.",
            },
            {
              title: "Misafir iletişimi",
              description: "İletişim ne kadar iyi olursa, işiniz de o kadar iyi olur. İlk temas noktasından başlayarak konaklama boyunca devam eden yerinde desteğe kadar misafirlerinizi mutlu edeceğiz ve evinizi güvende tutacağız.",
            },
            {
              title: "Premium banyo malzemeleri",
              description: "Biraz şımartmak asla kimsenin yüzüne bir gülümseme koymaktan geri kalmaz. Misafirlerinize birinci sınıf banyo malzemeleri sağlayarak standart Airbnb deneyimine lüks bir dokunuş katıyoruz. Saf mutluluk bekleyin.",
            },
            {
              title: "Taze nevresimler ve çamaşırhane",
              description: "Taze ve temiz yatak takımları, gevrek nevresimler ve yumuşak havlular iyi bir gece uykusu için gereklidir. Ekstra konfor için otel kalitesinde nevresimler sağlıyoruz. İyi dinlenmiş konuklardan parlak yorumlar alın.",
            },
            {
              title: "Yerel ipuçları",
              description: "Misafirlerinizin konaklamasını unutulmaz kılın. Gizli mücevherlerden mutlaka görülmesi gereken noktalara kadar bölgedeki en iyi turistik mekanlar hakkında içeriden bilgi sağlayarak konuklarınızın şehri yerel biri gibi deneyimlemelerini sağlıyoruz.",
            },
            {
              title: "Rehberli çıkış",
              description: "Misafirlerinize check-out sürecinde rehberlik edeceğiz, yerinizin güvenli olmasını, pencere ve kapıların kilitlenmesini ve anahtarların toplanmasını sağlayacağız. Siz ve misafirleriniz için stressiz bir deneyim.",
            },
          ],
        },
      },
    ...
    contact: {
      ...
      info: {
        ...
        contentPlaceholder: "İçerik buraya gelecek",
      },
    },
    quote: {
      ...
      propertyTab: {
        title: "Mülkünüz hakkında daha fazla bilgi verin",
        subtitle: "Mülkünüz hakkında daha fazla bilgi, onu bölgenizdeki benzer evlerle karşılaştırmamıza yardımcı olacaktır. Detayları doldurun, size e-posta yoluyla hizmet fiyat teklifi içeren kesin bir gelir raporu göndereceğiz.",
        address: "Adres",
      ...
      personalTab: {
        ...
        subtitle: "Size en iyi hizmeti sunabilmemiz için lütfen iletişim bilgilerinizi paylaşın.",
        fullName: "Ad Soyad",
        ...
        message: "Mesaj",
        messagePlaceholder: "Eklemek istediğiniz bir şey var mı? (opsiyonel)",
        submit: "Formu Gönder",
      },
      errors: {
      ...
      success: {
        ...
        message: "En kısa sürede size geri dönüş sağlayacağız.",
      },
      ariaLabels: {
        decrease: "Azalt",
        increase: "Artır",
    ...
    footer: {
      description:
        "Modern kurumsal çözümlerle işletmenizi geleceğe taşıyoruz.",
    ...
    propertyManagement: {
      title: {
        prefix: "Mülk yönetiminde",
        highlightWord: "yeni",
        suffix: "bir dönem başlatıyoruz.",
      },
      cards: [
        {
          type: "image",
    ...
    growth: {
      subtitle: "Bizim ile birlikte büyümeye",
      title: {
        prefix: "İşinizin",
        highlightWord: "Sınırları",
        middle: "Yok",
        suffix: "Bizimde yok",
      },
      sections: [
    ...
    services: {
      ...
      title: {
        prefix: "Kapsamlı",
        highlightWord: "hizmetlerimiz",
        suffix: "ile yanınızdayız",
      },
      tabs: [
        {
  ...
  en: {
    ...
    hero: {
      subtitle: "Professional short-term rental consulting",
      title: {
        prefix: "Transform your property into",
        suffix: "professional rental service",
      },
      rotatingWords: [
        "value",
        "revenue",
      ...
      services: {
        ...
        pricing: "Pricing",
        pricingMobile: "Pricing Calculation",
    ...
    about: {
      ...
      description2:
        "Prioritizing customer satisfaction, we aim for the highest quality standards in every project. We work with modern technologies and best practices, embracing a culture of continuous improvement and learning.",
      description3:
        "Our team consists of professionals who are experts in their fields and work for excellence in every project.",
      stats: {
      ...
      airbnbManagement: {
        title: "Your property has potential.",
        subtitle: "Get pricing information about your property, let's get in touch with you.",
        button: "Get Started",
        label: "airbnb management",
        guestExperience: {
          title: "A delightful experience for your guests",
          items: [
            {
              title: "Check-in and key exchange",
              description: "Make your guests' arrival effortless. We'll arrange a seamless and perfect check-in for every guest and be ready to assist them throughout their stay. Happy guests, always.",
            },
            {
              title: "Guest communication",
              description: "When communication is at its best, so is your business. From the first point of contact to ongoing on-site support, we'll keep your guests happy and your property secure.",
            },
            {
              title: "Premium bathroom amenities",
              description: "A little pampering never fails to put a smile on anyone's face. Add a touch of luxury to the standard Airbnb experience by providing your guests with first-class bathroom amenities. Expect pure happiness.",
            },
            {
              title: "Crisp fresh linens and laundry",
              description: "Fresh and clean bedding, crisp linens, and soft towels are essential for a good night's sleep. We provide hotel-quality linens for extra comfort. Get glowing reviews from well-rested guests.",
            },
            {
              title: "Local tips",
              description: "Make your guests' stay unforgettable. From hidden gems to must-see spots, we provide insider knowledge about the best tourist attractions in the area, allowing your guests to experience the city like a local.",
            },
            {
              title: "Guided checkout",
              description: "We'll guide your guests through the checkout process, ensuring your property is secure, windows and doors are locked, and keys are collected. A stress-free experience for you and your guests.",
            },
          ],
        },
      },
    ...
    contact: {
      ...
      info: {
        ...
        contentPlaceholder: "Content will come here",
      },
    },
    quote: {
      ...
      propertyTab: {
        ...
        subtitle: "More information about your property will help us compare it with similar homes in your area. Fill in the details, and we will send you a precise revenue report with a service price quote via email.",
        address: "Address",
        addressPlaceholder: "Enter your address",
        bedrooms: "Number of Bedrooms",
        bedroomsSelect: "Select",
        maxGuests: "Maximum Number of Guests",
        monthsLabel: "Which months are you planning to rent your property?",
        selectAll: "Select All",
        deselectAll: "Deselect All",
        ownerQuestion: "Do you already own this property?",
        yes: "Yes",
        no: "No",
        next: "Next",
        months: [
      ...
      personalTab: {
        ...
        subtitle: "Please share your contact information so we can provide you with the best service.",
        fullName: "Full Name",
        ...
        message: "Message",
        messagePlaceholder: "Is there anything you would like to add? (optional)",
        submit: "Submit Form",
      },
      errors: {
    ...
    footer: {
      description:
        "We take your business to the future with modern corporate solutions.",
    ...
    propertyManagement: {
      title: {
        prefix: "We are starting a",
        highlightWord: "new",
        suffix: "era in property management",
      },
      cards: [
        {
          type: "image",
    ...
    growth: {
      ...
      title: {
        prefix: "Your business has no",
        highlightWord: "limits",
        middle: "",
        suffix: "Neither do we",
      },
      sections: [
        {
          image: "/images/growth-1.jpg",
